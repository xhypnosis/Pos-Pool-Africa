    ...
    >
      <Router>
        <Layout className="layout">
          ...
          <div className="flex flex-col h-[900px] relative overflow-x-hidden bg-africa bg-no-repeat bg-top" style={{ backgroudSize: "1920px 348px" }}>
            <Header />
            ...
            <Content style={{ marginTop: "150px", backgroundColor: 'transparent' }}>
              <div>
                <Routes>
                  ...
                  <Route path="pool/core/:poolAddress" element={<Pool />} />
                  <Route path="pool/e-space/:poolAddress" element={<Pool />} />
                  <Route path="/" element={<Navigate to="pool/core/0x81388b499a6f76f47c78c35807c8d1ab4efa019a"/>} />
                </Routes>
              </div>
            </Content>
